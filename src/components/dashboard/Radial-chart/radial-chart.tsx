...
function CenterLabel({ totalInteractions, viewBox }: Readonly<CenterLabelProps>) {
...
export function RadialChart({ data }: Readonly<RadialChartProps>) {
  const chartData = [
    {
            ...
            >
              ...
              >
                ...
                <PolarRadiusAxis tick={false} tickLine={false} axisLine={false}>
                  <Label content={<CenterLabel totalInteractions={totalInteractions} />} />
                </PolarRadiusAxis>
                <RadialBar
                    dataKey="fan"
                    name="Fan"
